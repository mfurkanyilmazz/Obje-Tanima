# -*- coding: utf-8 -*-
'''
Created on Thu May 19 12:07:21 2022

@author: Muhammet Furkan
'''
...
#yolo416 hazır modelini kullanıcağız
...
labels = ['insan', 'bisiklet', 'araba', 'motorsiklet', 'uçak', 'otobüs', 'tren', 'kamyon', 'tekne',
          'trafik ışığı', 'yangın musluğu', 'dur işareti', 'parkmetre', 'banka', 'kuş', 'kedi',
          'köpek', 'at', 'koyun', 'inek', 'fil', 'ayı', 'zebra', 'zürafa', 'sırt çantası',
          'şemsiye', 'el çantası', 'kravat', 'bavul', 'frizbi', 'kayak', 'snowboard', 'spor topu',
          'uçurtma', 'beyzbol sopası', 'beyzbol eldiveni', 'kaykay', 'sörf tahtası', 'tenis raketi',
          'şişe', 'bardak', 'kupa', 'çatal', 'bıçak', 'kaşık', 'kase', 'muz', 'elma',
          'sandviç', 'portakal', 'brokoli', 'havuç', 'sosisli sandviç', 'pizza', 'çörek', 'kek', 'sandalye',
          'kanepe', 'saksı', 'yatak', 'yemek masası', 'tuvalet', 'tvmonitor', 'laptop', 'mouse',
          'uzaktan', 'keyboard', 'cep telefonu', 'mikrodalga', 'fırın', 'tost makinesi', 'lavabo', 'buzdolabı',
          'kitap', 'saat', 'vazo', 'makas', 'oyuncak ayı', 'fön makinesi', 'diş fırçası']
